...
## 프로젝트 소개
**WeGlean(위글린)** 은 플로깅 활동을 지원하고, 환경 보호에 기여하고자 하는 사용자들을 위한 모바일 앱 입니다.

앱 사용자는 **플로깅** 활동 *(일상적인 산책 중에 쓰레기를 줍는 활동)* 을 기록할 수 있습니다.

프로젝트의 목표는 환경 보호 활동을 일상의 즐거운 일부로 만들어 사용자들이 자발적으로 참여하도록 동기를 부여하는 것입니다. 

**WeGlean(위글린)** 은 사용자가 지속적으로 **개인 플로깅 활동**과 **플로깅 모임 활동**을 기록할 수 있도록 지원하고, 누적된 데이터를 캘린더를 통해 직관적으로 확인할 수 있도록 함으로써 사용자의 지속적인 참여를 장려합니다. 
